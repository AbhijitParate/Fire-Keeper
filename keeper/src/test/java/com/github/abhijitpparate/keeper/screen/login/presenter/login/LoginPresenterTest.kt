...
class LoginPresenterTest {
    ...
    fun setUp() {
        ...
        presenter = view?.let { LoginPresenter(it, authSource) }
    }
    ...
    fun onRegisterClick() {
        ...
        verify<LoginContract.View>(view).showRegistrationScreen()
    }
    ...
    fun onActiveUserFound() {
        ...
        presenter!!.getUser()
        verify<LoginContract.View>(view).showHomeScreen()
    }
    ...
    fun onActiveUserNotFound() {
        ...
        presenter!!.getUser()
        verify<LoginContract.View>(view).showProgressIndicator(false)
    }
    ...
    fun whenEmailEmpty() {
        ...
        verify<LoginContract.View>(view).makeToast(R.string.toast_error_email_empty)
    }
    ...
    fun whenEmailInvalid() {
        ...
        Mockito.`when`(view.password).thenReturn(VALID_PASSWORD)
        presenter!!.onLoginClick()
        verify<LoginContract.View>(view).makeToast(R.string.toast_error_invalid_email)
    }
    ...
    fun whenPasswordEmpty() {
        ...
        presenter!!.onLoginClick()
        verify<LoginContract.View>(view).makeToast(R.string.toast_error_password_empty)
    }
    ...
    fun whenPasswordTooLong() {
        ...
        presenter!!.onLoginClick()
        verify<LoginContract.View>(view).makeToast(R.string.toast_error_long_password)
    }
    ...
    fun whenPasswordTooShort() {
        ...
        presenter!!.onLoginClick()
        verify<LoginContract.View>(view).makeToast(R.string.toast_error_short_password)
    }
    ...
    fun onLoginFailure() {
        ...
        verify<LoginContract.View>(view).makeToast(anyInt())
    }
